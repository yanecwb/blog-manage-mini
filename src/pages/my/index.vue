<template>
  <view class="page">
    <view class="bg-my">
      <view class="sign-out" @click="handleSingOut"
        ><u-icon
          name="https://i.328888.xyz/2023/01/19/Heq7A.png"
          size="16"
          color="#fff"
          label="退出"
          labelColor="#fff"
      ...
      <image
        class="logo"
        :src="userInfo.avatarUrl || 'https://adminh5.demo.wueasy.com/static/images/my/mine_def_touxiang_3x.png'"
        draggable="false"
      ></image>
    ...
    <view class="cardcss">
      <u-form>
        <u-form-item
          prop="formData.account"
          v-for="(item, index) in MenuList"
          :key="index" 
          :borderBottom="index !== MenuList.length - 1"
        ...
        >
          <u-input
            ...
            suffix-icon-style="fontSize: 24rpx"
            readonly
            :value="item.value"
            color="#333"
            fontSize="26rpx"
    ...
    <view class="login-describe"
      >Copyright © 2022 wueasy All Rights Reserved.</view
    >
    <u-toast ref="uToast" />
  </view>
</template>
